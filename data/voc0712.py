    ...
    def __call__(self, target):
        ...
        for obj in target.iter('object'):
            ...
            for i, pt in enumerate(pts):
                cur_pt = int(bbox.find(pt).text)*2 - 1
...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root, image_sets, preproc=None, target_transform=None,
        ...
        self.ids = list()
        self._year = '2007'
        self.txt_dir = self.root+'/pcb.txt'
        '''
        ...
        '''
        for name in os.listdir(os.path.join(self.root,'Annotations')):
            self.ids.append((self.root,name.rstrip('.xml')))
