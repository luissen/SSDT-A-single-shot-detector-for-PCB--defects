...
VOCroot_train = '/data/Datasets/luzs/PCB/pcb_final_train'  # path to VOCdevkit root dir
VOCroot_test = '/data/Datasets/luzs/PCB/pcb_final_test'  # path to VOCdevkit root dir
