...
def upper_deconv(vgg, extracts, size):    
    layers = []
    if size == 300:
        layers.append(BasicConv(512+128*5, 128*6, kernel_size=1, padding=0))
        layers+=[(BasicConv(vgg[-2].out_channels+128*4,128*5,kernel_size=1,padding=0,up_size = 38))]
        layers.append(BasicConv(extracts[1].out_channels+128*3,128*4,kernel_size=1,padding=0,up_size = 19))
        layers.append(BasicConv(extracts[3].out_channels+128*2,128*3,kernel_size=1,padding=0,up_size = 10))
        layers.append(BasicConv(extracts[5].out_channels+128,128*2,kernel_size=1,padding=0,up_size = 5))
        layers.append(BasicConv(extracts[7].out_channels,128*1,kernel_size=1,padding=0,up_size = 3))
    elif size ==512:
        layers.append(BasicConv(512+128*6, 128*7, kernel_size=1, padding=0))
        layers.append(BasicConv(vgg[-2].out_channels+128*5,128*6,kernel_size=1,padding=0,up_size = 64))
        layers.append(BasicConv(extracts[1].out_channels+128*4,128*5,kernel_size=1,padding=0,up_size = 32))
        layers.append(BasicConv(extracts[3].out_channels+128*3,128*4,kernel_size=1,padding=0,up_size = 16))
        layers.append(BasicConv(extracts[5].out_channels+128*2,128*3,kernel_size=1,padding=0,up_size = 8))
        layers.append(BasicConv(extracts[7].out_channels+128*1,128*2,kernel_size=1,padding=0,up_size = 4))
